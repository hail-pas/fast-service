...
class HelloStub:
    ...
    def __init__(self, channel) -> None:
        ...
        self.HelloRPC = channel.unary_unary(
            "/Hello/HelloRPC",
            request_serializer=hello__pb2.HelloIn.SerializeToString,
            response_deserializer=hello__pb2.HelloOut.FromString,
        )
        self.MultiHelloRPC = channel.unary_unary(
            "/Hello/MultiHelloRPC",
            request_serializer=hello__pb2.HelloIn.SerializeToString,
            response_deserializer=hello__pb2.MultiHelloOut.FromString,
        )
...
def add_HelloServicer_to_server(servicer, server):
    rpc_method_handlers = {
        "HelloRPC": grpc.unary_unary_rpc_method_handler(
            servicer.HelloRPC,
            request_deserializer=hello__pb2.HelloIn.FromString,
            response_serializer=hello__pb2.HelloOut.SerializeToString,
        ),
        "MultiHelloRPC": grpc.unary_unary_rpc_method_handler(
            servicer.MultiHelloRPC,
            request_deserializer=hello__pb2.HelloIn.FromString,
            response_serializer=hello__pb2.MultiHelloOut.SerializeToString,
        ),
...
class Hello:
    ...
    def HelloRPC(
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            "/Hello/HelloRPC",
            hello__pb2.HelloIn.SerializeToString,
            hello__pb2.HelloOut.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def MultiHelloRPC(
        ...
        return grpc.experimental.unary_unary(
            ...
            "/Hello/MultiHelloRPC",
            hello__pb2.HelloIn.SerializeToString,
            hello__pb2.MultiHelloOut.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
